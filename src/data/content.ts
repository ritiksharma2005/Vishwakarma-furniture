...
export const PRODUCT_CATEGORIES: ProductCategory[] = [
  ...
  },
  {
  ...
  },
   {
    ...
    nameHi: 'मंदिर / पूजा घर',
    // TODO: replace with a real photo of a mandir/pooja unit you've made —
    // this is a placeholder using the workshop shot for now.
    image: '/images/mandir-units.png',
    description:
      'Hand-carved wooden mandir and pooja units, sized and detailed to fit your home — from a simple wall-mounted shelf to a full standing temple unit.',
    tags: ['Hand-carved', 'Custom size', 'Wall or standing'],
  },
]
